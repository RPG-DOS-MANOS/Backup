...
class TextField extends InputComponent {
    ...
    async _getElement(entity, isEditable = true, options = {}) {
        ...
        if (!entity.isTemplate && this._autocomplete) {
            const autocompleteOptions = ComputablePhrase.computeMessageStatic(this._autocomplete, entity.system.props, {
    ...
    static async getConfigForm(existingComponent, _entity) {
        ...
        mainElt.append(await renderTemplate(`systems/${game.system.id}/templates/_template/components/textField.html`, existingComponent));
        return mainElt;
    }
    /**
