...
class ConditionalModifierList extends ExtensibleTable {
     ...
     */
    constructor({ key, tooltip = null, templateAddress, head = false, headDisplay = true, infoDisplay = false, selectionLabel = 'Selected', selectionAlign = null, groupLabel = 'Group', groupAlign = null, groupFilter = [], groupFilterFormula = null, cssClass = null, role = 0, permission = 0, visibilityFormula = null, parent = null }) {
        super({
            key: key,
            tooltip: tooltip,
    ...
    /**
     * @typedef {ExtensibleTableJson} ConditionalModifierListJson
     * @type {Object}
     * @property {boolean} headDisplay
     * @property {boolean} infoDisplay
     * @property {string} selectionLabel
     * @property {string} selectionAlign
     * @property {string} groupLabel
     * @property {string} groupAlign
     * @property {string[]} groupFilter
     * @property {string} groupFilterFormula
     * @property {string} type
     */
    /**
     * Returns serialized component
     * @override
     * @return {ConditionalModifierListJson}
     */
    toJSON() {
     ...
     * @param {ConditionalModifierListJson?} existingComponent
    ...
    static async getConfigForm(existingComponent, entity) {
        ...
        mainElt.append(await renderTemplate('systems/' + game.system.id + '/templates/_template/components/conditionalModifierList.html', existingComponent));
        return mainElt;
    }
    /**
     ...
     * @return {ConditionalModifierListJson} The JSON representation of the component
     ...
     * @private
     * @param key {String}
     * @param modifiers {Array<{description: string, originalEntity: TemplateSystem}>}
     * @param entity {TemplateSystem}
