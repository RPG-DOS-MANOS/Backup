...
const gmodule = import(`${globalThis.location.origin}${foundry.utils.getRoute('/scripts/greensock/esm/all.js')}`);
...
Hooks.on("ready", async function () {
    ...
    let masteroftime = game.settings.get(MODULE_NAME, "masteroftime");
    ...
    //await gsap as it could be still loading
    await gmodule;
...
//@ts-ignore
export const gsap = (await gmodule).gsap;
