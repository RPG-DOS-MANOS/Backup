...
export class SoundSubSettings extends FormApplication {
    ...
    getData(options) {
        ...
        for (const setting of data.settings) {
            ...
            s.name = game.i18n.localize(setting.name);
            s.hint = game.i18n.localize(setting.hint);
            settings.push(s);
        }
        return settings;
    }
    ...
    onAudioPreview(event) {
        ...
        const volume = this.form.volume.value;
