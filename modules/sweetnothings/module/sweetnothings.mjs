...
import { AboutDialog, Logger } from "./geekdialog/geekdialogs.mjs";
    ...
    static async _checkGreetings() {
        ...
        if (!initialGreeting) {
            ...
            let chatData = {
                author: game.userId,
                content,
                type: foundry.utils.isNewerVersion(game.version, "12") ? CONST.CHAT_MESSAGE_STYLES.OTHER : CONST.CHAT_MESSAGE_TYPES.WHISPER,
                whisper: [game.userId],
                speaker: null
            };
