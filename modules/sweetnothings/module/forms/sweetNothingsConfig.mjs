...
import { HelpFormApplication } from "../geekdialog/geekdialogs.mjs";
...
export class SweetNothingsConfig extends HelpFormApplication {
    ...
    async getData(options) {
        ...
        let isV12 = foundry.utils.isNewerVersion(game.version, "12");
        ...
        return { sweetSettings, enableSound, enableNotification, notificationSound, notificationVolume, historyLength, enableRollInHistory, enableRollToastNotification, enableRollSoundNotification, externalModules, isV12 };
    }
