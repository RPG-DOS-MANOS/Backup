...
export class ObsidianDialog extends DocumentSheet {
	...
	static initialiseComponents (html) {
		...
		html.find('.obsidian-number-decrement').click(evt => {
			const value = evt.currentTarget.nextElementSibling;
		...
		html.find('.obsidian-number-increment').click(evt => {
			const value = evt.currentTarget.previousElementSibling;
			const amount = Number(value.value);
