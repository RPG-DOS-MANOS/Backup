...
export class ValidSpec {
    ...
    static createValidMods() {
        ...
        for (let specKey of Object.keys(CONFIG.Actor.dataModels)) {
            ...
            specials["macro.StatusEffect"] = ["", ACTIVE_EFFECT_MODES.CUSTOM];
...
export class DAESystem {
    ...
    static safeEval(expression, sandbox, onErrorReturn = undefined) {
        ...
        try {
            ...
            //@ts-expect-error
            sandbox = foundry.utils.mergeObject(sandbox, { Roll, fromUuidSync });
            sandbox = foundry.utils.mergeObject(sandbox, { MidiQOL: globalThis.MidiDAEEval ?? {} });
