import { timesUpInstalled, simpleCalendarInstalled, allMacroEffects, getMacro, tokenForActor, delay, actorFromUuid, getTokenDocument, getToken } from "./dae.js";
...
export function convertDuration(itemDuration, inCombat) {
    ...
    if (!simpleCalendarInstalled) {
        switch (itemDuration.units) {
            ...
            default:
                warn("dae | unknown time unit found", itemDuration.units);
