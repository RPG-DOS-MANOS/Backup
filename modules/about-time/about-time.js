    ...
    operations = {
        ...
        startRunning: () => {
            if (ElapsedTime.debug)
                console.error("about-time | startRunning deprecated use SimpleCalendar.api.startClock()");
            globalThis.SimpleCalendar.api.startClock();
        },
        stopRunning: () => {
            if (ElapsedTime.debug)
                console.error("about-time | stopRunning not supported use SimpleCalendar.api.stopClock()");
