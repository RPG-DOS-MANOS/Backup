    ...
    static createFromJSON(data) {
        ...
        try {
            if (data.handler.type === "function")
                handler = eval("handler = " + data.handler.val);
            else
        ...
        return new Quentry(data.time, data.recurring, data.recurring ? data.increment : null, handler, data.uid, data.originator, ...data.args);
    }
}
